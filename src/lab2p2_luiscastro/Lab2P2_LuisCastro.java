...
static Scanner leerS = new Scanner(System.in);
    ...
    public static void main(String[] args) throws ParseException {
        ...
        while(respuesta.equals("Si")){
            ...
            System.out.println("Desea continuar? (Iniciar Sesion de nuevo)");
            System.out.println("Solo se continuara si la respuesta es un 'Si'.");
            System.out.println("Ingrese su respuesta:");
            respuesta = leerS.nextLine();
        }//FIN DEL WHILE INICIO SESION
